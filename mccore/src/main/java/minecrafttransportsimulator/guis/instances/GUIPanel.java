...
public class GUIPanel extends AGUIBase {
        ...
        for (JSONPanelComponent panelComponent : definition.panel.components) {
            ...
            if (panelComponent.specialComponent == null) {
                ...
                switch (panelComponent.specialComponent) {
                    ...
                    case ROLL_TRIM: {
                        newComponent = new GUIPanelTrimButton(panelComponent, vehicle.aileronTrimVar, -0.1, EntityVehicleF_Physics.MAX_AILERON_TRIM);
                        text = "ROLL TRIM";
                        break;
                    }
                    case PITCH_TRIM: {
                        newComponent = new GUIPanelTrimButton(panelComponent, vehicle.elevatorTrimVar, 0.1, EntityVehicleF_Physics.MAX_ELEVATOR_TRIM);
                        text = "PITCH TRIM";
                        break;
                    }
                    case YAW_TRIM: {
                        newComponent = new GUIPanelTrimButton(panelComponent, vehicle.rudderTrimVar, -0.1, EntityVehicleF_Physics.MAX_RUDDER_TRIM);
                        text = "YAW TRIM";
                        break;
                    }
                }
    ...
    private class GUIPanelTrimButton extends GUIPanelButton {
        ...
        private GUIPanelTrimButton(JSONPanelComponent component, ComputedVariable trimVariable, double leftIncrement, double bounds) {
            super(component);
