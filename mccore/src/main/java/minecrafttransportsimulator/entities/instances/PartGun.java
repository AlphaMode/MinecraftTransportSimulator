    ...
    public ComputedVariable createComputedVariable(String variable) {
        switch (variable) {
            ...
            case ("gun_controller_firstperson"):
                return new ComputedVariable(this, variable, partialTicks -> InterfaceManager.clientInterface.getClientPlayer().equals(lastController) && InterfaceManager.clientInterface.inFirstPerson() ? 1 : 0, false);
            case ("gun_active"):
