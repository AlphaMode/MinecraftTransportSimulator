...
//        if (!runningJoystickThread) { TODO: PORT
...
//        }
    ...
    public String getNameForKeyCode(int keyCode) {
        return InputConstants.getKey(keyCode, InputConstants.RELEASE).getDisplayName().getString();
    }
    ...
    public boolean isJoystickPresent(String joystickName) {
        return false;//!joystickInhibited && runningClassicMode ? classicJoystickMap.containsKey(joystickName) : joystickMap.containsKey(joystickName);
    }

    @Override
    public List<String> getAllJoystickNames() {
        return List.of();//new ArrayList<>(runningClassicMode ? classicJoystickMap.keySet() : joystickMap.keySet());
    }

    @Override
    public int getJoystickComponentCount(String joystickName) {
        return 0;//runningClassicMode ? classicJoystickMap.get(joystickName).getComponents().length : joystickComponentCounts.get(joystickName);
    }
...
//        }
    ...
    public boolean isJoystickComponentAxis(String joystickName, int index) {
        return false;//runningClassicMode ? classicJoystickMap.get(joystickName).getComponents()[index].isAnalog() : GLFW.glfwGetJoystickAxes(joystickMap.get(joystickName)).limit() > index;
    }
...
//        }
    ...
    @SubscribeEvent
    public static void rgisterKeyMappings(RegisterKeyMappingsEvent event) {
     ...
     */
    @SubscribeEvent
    public static void onIVMouseScroll(InputEvent.MouseScrollingEvent event) {
