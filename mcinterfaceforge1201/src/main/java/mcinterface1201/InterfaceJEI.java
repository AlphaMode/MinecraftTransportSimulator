...
public class InterfaceJEI implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ...
        for (BenchRecipeCategory benchCategory : benchCategories) {
            registration.addRecipes(RecipeType.create(InterfaceManager.coreModID, benchCategory.benchItem.getRegistrationName(), PackRecipeWrapper.class), benchCategory.benchRecipes);
        }
    }
    ...
    private static class BenchRecipeCategory implements IRecipeCategory<PackRecipeWrapper> {
        ...
        private BenchRecipeCategory(ItemDecor benchItem, List<PackRecipeWrapper> benchRecipes, IGuiHelper guiHelper) {
            this.recipeType = RecipeType.create(InterfaceManager.coreModID, benchItem.getRegistrationName(), PackRecipeWrapper.class);
            ...
            this.icon = guiHelper.createDrawableItemStack(((WrapperItemStack) benchItem.getNewStack(null)).stack);
        }
        ...
        public void setRecipe(IRecipeLayoutBuilder builder, PackRecipeWrapper recipe, IFocusGroup focuses) {
            ...
            if (components != null) {
                ...
                builder.addSlot(RecipeIngredientRole.OUTPUT, 58, 70).addItemStack(((WrapperItemStack) recipe.packItem.getNewStack(null)).stack);
            }
        }
    }
}
