...
public class InterfaceInterface {
    ...
    public static BuilderEntityExisting toExternal(AEntityB_Existing entity) {
        if (((WrapperWorld) entity.world).world instanceof ServerLevel serverLevel) {
            for (Entity mcEntity : serverLevel.getAllEntities()) {
                if (mcEntity instanceof BuilderEntityExisting builderEntity) {
                    if (entity.equals(builderEntity)) {
