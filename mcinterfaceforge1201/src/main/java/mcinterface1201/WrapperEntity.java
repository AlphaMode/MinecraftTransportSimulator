...
public class WrapperEntity implements IWrapperEntity {
    ...
    public float getBodyYaw() {
        return entity instanceof LivingEntity living ? -living.yBodyRot : 0;
    }
    ...
    public boolean leashTo(IWrapperPlayer player) {
        ...
        if (entity instanceof Mob mob) {
            ...
            if (mob.canBeLeashed(mcPlayer) && heldStack.getItem() instanceof LeadItem) {
                mob.setLeashedTo(mcPlayer, true);
...
//        }
//        entity.hurt(newSource, (float) damage.amount); TODO: PORT
